...
#define INIT_INTERRUPT(NAME, GPIO, PIN, FLAG, IRQn)                            \
  GPIOinConfigure(GPIO, PIN, GPIO_PuPd_UP, EXTI_Mode_Interrupt,                \
...
void EXTI9_5_IRQHandler(void) { generic_handler(5, 9); }

void EXTI15_10_IRQHandler(void) { generic_handler(10, 15); }

void EXTI0_IRQHandler(void) { generic_handler(0, 0); }

void EXTI3_IRQHandler(void) { generic_handler(3, 3); }

void EXTI4_IRQHandler(void) { generic_handler(4, 4); }
